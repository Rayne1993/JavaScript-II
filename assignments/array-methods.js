...
runners.forEach(r => fullName.push(r.first_name) + fullName.push(r.last_name));
...
// Problem 1
const nameID = runners.map(function(r) {
...
// Problem 2
const company = runners.filter(r => r.company_name === "Skinix");

console.log(company);

// Problem 3
const nameEmail = runners.map(function(r) {
